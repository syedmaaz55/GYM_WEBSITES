        ...
        <main className="bg-black text-white pt-24 min-h-screen">
            ...
            <section className="py-20 px-6 text-center">
                ...
                >
                    <h1 className="text-6xl md:text-8xl font-black uppercase italic tracking-tighter mb-4">
                        GET IN <span className="text-[#73BB1B]">TOUCH</span>
                    </h1>
            ...
            <section className="py-12 px-6">
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
                    ...
                    >
                        <div>
                            <h2 className="text-3xl font-black uppercase italic mb-8 border-l-4 border-[#73BB1B] pl-6">Contact Information</h2>
                            <div className="space-y-8">
                                <div className="flex items-start gap-6 group">
                                    <div className="w-12 h-12 bg-zinc-900 border border-white/10 flex items-center justify-center rounded-xl group-hover:bg-[#73BB1B] transition-all">
                                        <MapPin className="text-[#73BB1B] group-hover:text-white" size={24} />
                                    </div>
                                    <div>
                                ...
                                <div className="flex items-start gap-6 group">
                                    <div className="w-12 h-12 bg-zinc-900 border border-white/10 flex items-center justify-center rounded-xl group-hover:bg-[#73BB1B] transition-all">
                                        <Phone className="text-[#73BB1B] group-hover:text-white" size={24} />
                                    </div>
                                    <div>
                                        <p className="text-zinc-500 uppercase text-[10px] font-black tracking-widest mb-1">Call / WhatsApp</p>
                                        <a href="https://wa.me/923001234567" target="_blank" className="text-white font-bold text-lg hover:text-[#73BB1B] transition-colors flex items-center gap-2">
                        ...
                        <div className="w-full h-[300px] rounded-[30px] overflow-hidden border border-white/10 grayscale hover:grayscale-0 transition-all duration-700">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3621.5714!2d67.0681!3d24.8138!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjTCsDQ4JzQ5LjciTiA2N8KwMDQnMDYuMSJF!5e0!3m2!1sen!2spk!4v1630000000000!5m2!1sen!2spk"
                    ...
                    <motion.div 
                        ...
                        viewport={{ once: true }}
                        variants={fadeInUp}
                        className="bg-zinc-900/50 p-8 md:p-12 rounded-[40px] border border-white/5 relative overflow-hidden"
                    >
                        {isSuccess ? (
                            <div className="text-center py-10 animate-in fade-in zoom-in duration-500">
                                <CheckCircle2 className="mx-auto text-[#73BB1B] mb-6" size={80} />
                                ...
                                <form ref={form} onSubmit={sendEmail} className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <input type="text" name="name" minLength={3} maxLength={40} placeholder="John Doe" className="w-full bg-black border border-white/10 p-4 rounded-2xl focus:border-[#73BB1B] outline-none transition-all" required />
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-[10px] uppercase font-black tracking-widest text-zinc-500 ml-2">Phone Number</label>
                                            <input type="tel" name="phone" pattern="[0-9]{10,15}" title="Please enter a valid phone number" placeholder="03001234567" className="w-full bg-black border border-white/10 p-4 rounded-2xl focus:border-[#73BB1B] outline-none transition-all" required />
                                        </div>
                                    </div>

                                    <div className="space-y-2">
                                        <label className="text-[10px] uppercase font-black tracking-widest text-zinc-500 ml-2">Email Address</label>
                                        <input type="email" name="email" placeholder="john@example.com" className="w-full bg-black border border-white/10 p-4 rounded-2xl focus:border-[#73BB1B] outline-none transition-all" required />
                                    </div>

                                    <div className="space-y-2">
                                        <label className="text-[10px] uppercase font-black tracking-widest text-zinc-500 ml-2">Your Message</label>
                                        <textarea name="message" rows={4} minLength={10} placeholder="I want to join..." className="w-full bg-black border border-white/10 p-4 rounded-2xl focus:border-[#73BB1B] outline-none transition-all resize-none" required></textarea>
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className="w-full bg-[#73BB1B] text-white py-5 rounded-2xl font-black uppercase italic tracking-widest flex items-center justify-center gap-4 hover:bg-white hover:text-black transition-all disabled:opacity-30 disabled:cursor-not-allowed"
                                    >
